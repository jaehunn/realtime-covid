...
const ToggleSwitcher = () => {
  ...
  return (
    <button className="w-12 h-5 rounded-full bg-gray-200 flex items-center transition duration-300 focus:outline-none" onClick={themeToggle}>
      <div className="w-6 h-5 relative rounded-full transition duration-500 transform p-1 leading-10" ref={toggleEl}></div>
    </button>
  );
};
