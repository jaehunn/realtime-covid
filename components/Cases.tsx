...
const Cases = ({
  ...
  return (
    <div className="w-1/2 h-32 flex flex-row flex-1 justify-evenly m-auto mt-16">
      <div className="w-40 h-24 bg-blue-50 border flex flex-col justify-center items-center shadow-lg rounded-md text-red-400 dark:bg-gray-600 dark:border-gray-500">
      ...
      <div className="w-40 h-24 bg-blue-50 border flex flex-col justify-center items-center shadow-lg rounded-md text-black dark:bg-gray-600 dark:border-gray-500">
      ...
      <div className="w-40 h-24 bg-blue-50 border flex flex-col justify-center items-center shadow-lg rounded-md text-green-400 dark:bg-gray-600 dark:border-gray-500">
      ...
      <div className="w-40 h-24 bg-blue-50 border flex flex-col justify-center items-center shadow-lg rounded-md text-blue-400 dark:bg-gray-600 dark:border-gray-500">
